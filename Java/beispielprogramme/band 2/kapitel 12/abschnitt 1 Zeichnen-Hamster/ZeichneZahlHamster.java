import de.hamster.debugger.model.Territorium;import de.hamster.debugger.model.Territory;import de.hamster.model.HamsterException;import de.hamster.model.HamsterInitialisierungsException;import de.hamster.model.HamsterNichtInitialisiertException;import de.hamster.model.KachelLeerException;import de.hamster.model.MauerDaException;import de.hamster.model.MaulLeerException;import de.hamster.model.MouthEmptyException;import de.hamster.model.WallInFrontException;import de.hamster.model.TileEmptyException;import de.hamster.debugger.model.Hamster;class ZeichneZahlHamster extends Hamster {
    ...
    ZeichneZifferHamster[] erzeugeZifferHamster() {
        ...
        ziffernHamster[0] = new ZeichneNullHamster(r, s,
                Hamster.OST, this.getAnzahlKoerner());
        ziffernHamster[1] = new ZeichneEinsHamster(r, s,
                Hamster.OST, this.getAnzahlKoerner());
        ziffernHamster[2] = new ZeichneZweiHamster(r, s,
                Hamster.OST, this.getAnzahlKoerner());
        ziffernHamster[3] = new ZeichneDreiHamster(r, s,
                Hamster.OST, this.getAnzahlKoerner());
        ziffernHamster[4] = new ZeichneVierHamster(r, s,
                Hamster.OST, this.getAnzahlKoerner());
        ziffernHamster[5] = new ZeichneFuenfHamster(r, s,
                Hamster.OST, this.getAnzahlKoerner());
        ziffernHamster[6] = new ZeichneSechsHamster(r, s,
                Hamster.OST, this.getAnzahlKoerner());
        ziffernHamster[7] = new ZeichneSiebenHamster(r, s,
                Hamster.OST, this.getAnzahlKoerner());
        ziffernHamster[8] = new ZeichneAchtHamster(r, s,
                Hamster.OST, this.getAnzahlKoerner());
        ziffernHamster[9] = new ZeichneNeunHamster(r, s,
                Hamster.OST, this.getAnzahlKoerner());

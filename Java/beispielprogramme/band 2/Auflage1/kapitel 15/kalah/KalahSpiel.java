  ...
  public void spielen() {
    ...
    while (true) {
      ...
      if (this.schiedsrichter.istSpielBeendet()) {
        // die verbliebenen Koerner muessen noch in die Kalahs
        // gepackt werden
        ...
        if (sieger == null) {
          ...
          // zur Belohnung duerfen die Hamster noch die Koerner in
          // ihren Kalahs fressen
          aktuellerSpieler.spielBeenden(false);
          Spieler gegner = 
            this.schiedsrichter.liefereGegner(aktuellerSpieler);
         ...
         this.schiedsrichter.schreib(
          ...
          Spieler gegner = 
            this.schiedsrichter.liefereGegner(sieger);
          gegner.spielBeenden(false);
        }

...
import de.hamster.debugger.model.Territorium;import de.hamster.model.HamsterException;import de.hamster.model.HamsterInitialisierungsException;import de.hamster.model.HamsterNichtInitialisiertException;import de.hamster.model.KachelLeerException;import de.hamster.model.MauerDaException;import de.hamster.model.MaulLeerException;import de.hamster.debugger.model.Hamster;class NGewinntHamster extends Hamster {
  ...
  NGewinntHamster(int farbe) {
    this.init(RegelHamster.FELD_GROESSE-1, 0, Hamster.OST,
              RegelHamster.FELD_GROESSE*RegelHamster.FELD_GROESSE*
                farbe
             );
    // die Anzahl der Koerner im Maul der Hamster reicht auf jeden 
    // Fall aus
    this.farbe = farbe;
  }
  
  void fuehreNaechstenSpielzugAus() {
    // die Hamster verfolgen keine Strategie; die Spaltenauswahl
    // geschieht per Zufall
  ...
  boolean legeScheibeAb() {
    // legt oberhalb der letzten Scheibe eine weitere Scheibe ab;
    // falls die Spalte schon voll ist, wird false geliefert

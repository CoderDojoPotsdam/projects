...
// Kalah-Spiels
import de.hamster.debugger.model.Territorium;import de.hamster.debugger.model.Territory;import de.hamster.model.HamsterException;import de.hamster.model.HamsterInitialisierungsException;import de.hamster.model.HamsterNichtInitialisiertException;import de.hamster.model.KachelLeerException;import de.hamster.model.MauerDaException;import de.hamster.model.MaulLeerException;import de.hamster.model.MouthEmptyException;import de.hamster.model.WallInFrontException;import de.hamster.model.TileEmptyException;import de.hamster.debugger.model.Hamster;public class SchiedsrichterHamster extends AllroundHamster {
    // Attribute
    ...
    public boolean istEndzustandVonSpielerAOk() {
        ...
        if (Territorium.getAnzahlKoerner(this.getReihe(), this
                ...
                .liefereAnzahlKoerner(Spielbrett.KALAH_A)) {
            return false;
        }
    ...
    public boolean istEndzustandVonSpielerBOk() {
        ...
        if (Territorium.getAnzahlKoerner(this.getReihe(), this
                .getSpalte()) != this.brett
                .liefereAnzahlKoerner(Spielbrett.KALAH_B)) {
            return false;
        }
        this.gehZumAusgangspunkt();
        return true;
    ...
    protected boolean kontrolliereTerritorium() {
        ...
        this.rechtsUm();
        this.vor();
        if (this.brett.liefereAnzahlKoerner(Spielbrett.KALAH_B) != Territorium
                .getAnzahlKoerner(this.getReihe(), this
                        .getSpalte())) {
            return false;
        }
